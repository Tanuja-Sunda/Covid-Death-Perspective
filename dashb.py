...
VacDist.drop(['Sessions'], axis=1, inplace=True)
...
VacDist.rename(columns={"Total Individuals Vaccinated":"Total", "First Dose Administered":"First Dose", "Second Dose Administered":"Second Dose",
                       ...
                       "Covaxin (Doses Administered)":"Covaxin","CoviShield (Doses Administered)":"Covishield"}, inplace = True)
...
dfmajorillness=pd.read_csv(r'combine.csv',sep=',')
